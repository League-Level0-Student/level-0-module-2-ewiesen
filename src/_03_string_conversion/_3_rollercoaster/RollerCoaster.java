...
public class RollerCoaster {
	...
	public static void main(String[] args) {
		...
		if (heightAsInt >= 48) {
			// "Hurray! You are tall enough to ride the coaster alone!" Hint: use JoptionPan
			JOptionPane.showMessageDialog(null, "Hurray! You are tall enough\nto ride the coaster alone!");
		}
		...
		// coaster pal!"
			...
			JOptionPane.showMessageDialog(null, "You need to grow some more\nbefore you can ride!");
		}
